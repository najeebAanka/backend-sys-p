...
//      nodeItem.addEventListener("dragstart", function(event){
//          console.log("hello !");
//      }, false);
//      nodeItem.setAttribute('draggable' ,true);
      ...
      board.insertBefore(nodeItem, board.firstChild)
      return self
    }
    ...
    this.findBoard = function (id) {
     ...
     this.findTrashCan = function () {
      var el = document.querySelector('[data-id="delete-kanban-trashcan"]')
      return el
    }
    ...
    this.moveElement = function (targetBoardID, elementID, element) {
      ...
      if (targetBoardID === this.getParentBoardID(elementID)) {
       ...
       if (targetBoardID === this.findTrashCan()) {
...
if(item.type == 'lead'){
    ...
    result = '<div  class=\'item_handle \'><b>' + item.title + '</b><br />\n\
' + item.timestamp + '<br /><i class="fa fa-clock opac"></i> Activities</div>'  
}
...
//              }
//
//              result = '<div  class=\'item_handle \'><b>' + result + '</b><br />12,000 AED<br />\n\
//6 hours ago<br /><i class="fa fa-clock opac"></i> Schedule</div>'
//          } else {
//              result = '<div> ' + self.options.itemHandleOptions.customHandler.replace(/%([^%]+)%/g, function (match, key) 
//                      { return item[key] !== undefined ? item[key] : '' }) + ' </div>'
//              return result
